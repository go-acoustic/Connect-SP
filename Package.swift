...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/2.0.5/Connect_XCFramework_Release.zip",
            checksum: "76c8e818f92a3712e65b1aeb6149f01ef339bb70f3f8221c1993bf8de4cfe48b"),
        .binaryTarget(
            name: "Tealeaf",
