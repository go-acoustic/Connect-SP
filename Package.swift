...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.81/Connect_XCFramework_Release.zip",
            checksum: "2c1bb34787343dab0e3cf8dd1a3c5b8b815f2334d2ba31b6d3423ea2c68ededb"),
        .binaryTarget(
            name: "Tealeaf",
