...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.29/Connect_XCFramework_Release.zip",
            checksum: "4e0830a4e1a71184fb4a4fb4f51e50d1994adbfe7564cd67da83fedbd6020958"),
        .binaryTarget(
            name: "Tealeaf",
