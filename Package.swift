...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.78/Connect_XCFramework_Release.zip",
            checksum: "f900962a0917c7291a490036f1cd7e38dacb0e5bd6b5340332a87b943bbcfc7e"),
        .binaryTarget(
            name: "Tealeaf",
