...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Connect",
            url: "https://github.com/go-acoustic/Connect/releases/download/1.0.15/Connect_XCFramework_Release.zip",
            checksum: "0fd903c99b86310d55e8b70ca62a834ba7dcb05432cf0fd79d388ca7b6e217bf"),
        .binaryTarget(
            name: "Tealeaf",
